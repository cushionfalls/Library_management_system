        ...
        <div class="hero-visual">
            <div class="relative w-full max-w-[520px] mx-auto">
                <div class="hero-main-card">
                    <h3 class="text-2xl font-bold mb-2">Paper Library</h3>
                    <p class="opacity-90">Dive into your next adventure. Your library is waiting for you.</p>
                    <a href="<?php echo APP_ROUTE; ?>?page=books" class="btn-lms mt-6 bg-white text-primary"><i class="fas fa-compass"></i> Browse Catalog</a>
                </div>
